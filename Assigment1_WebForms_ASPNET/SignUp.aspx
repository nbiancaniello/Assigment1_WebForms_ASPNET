...
<asp:Content ID="Content" ContentPlaceHolderID="NavContentDisplay" runat="server">
    <div>
        ...
        <tr>
            ...
            <td style="width: 205px"><asp:RequiredFieldValidator runat="server" ID="reqEmail" ControlToValidate="txtEmail" ErrorMessage="Email is Required" CssClass="lblError"/></td>
            <td style="width: 388px"><asp:RegularExpressionValidator runat="server" ID="regEmail" ControlToValidate="txtEmail" ErrorMessage="Email is Invalid" CssClass="lblError" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"/></td>
        </tr>
        <tr>
